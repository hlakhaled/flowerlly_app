...
import 'package:flowerlly_app/features/status/presentation/widgets/list_of_check_box.dart';
...
class _CalenderBodyScreenState extends State<CalenderBodyScreen> {
  ...
  // Example task status: true = completed (✔️), false = not completed (❌)
  final Map<DateTime, bool> _taskStatus = {
    DateTime.utc(2025, 2, 5): true, // ✔️ Completed
  ...
  void _toggleTaskStatus(DateTime day) {
    setState(() {
      if (_taskStatus.containsKey(day)) {
        ...
        _taskStatus[day] = false; // Default to not completed
      }
    });
  }
